<div>
    <div class="row">
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    ...
                    <input wire:model.debounce.live.300ms="search" type="text" class="form-control" placeholder="Search Service Reports...">
                </div>
                <div class="card-body">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ ($serviceReports->currentPage() - 1) * $serviceReports->perPage() + $loop->index + 1 }}</td>
                                <td>{{ $report->name }}</td>
                                <td>
                            ...
                            @empty
                            <tr>
                                <td colspan="3">No Service Reports Found</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
        ...
        <!-- Create/Update Service Report Form -->
        <div class="col-md-4">
            <div class="card">
                <div class="card-header">
                    <h5>{{ $reportId ? 'Edit Service Report' : 'Create Service Report' }}</h5>
                </div>
                <div class="card-body">
