<div>
    <div class="row">
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h5>Units</h5>
                    <input wire:model.debounce.live.300ms="search" type="text" class="form-control" placeholder="Search Units...">
                </div>
                <div class="card-body">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button wire:click="edit({{ $unit->id }})" class="btn btn-primary btn-sm">Edit</button>
        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-header">
                    <h5>{{ $unitId ? 'Edit Unit' : 'Create Unit' }}</h5>
                </div>
                <div class="card-body">
                    <form wire:submit.prevent="store">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" wire:model="abbreviation">
