                            ...
                            <div class="col-lg-3">
                                <div class="nav flex-column custom-nav nav-pills"
                                    ...
                                    <button class="nav-link active"
                                            ...
                                            aria-controls="v-pills-cust-entry"
                                            aria-selected="true">
                                    ...
                                    <button class="nav-link"
                                            id="v-pills-initial-check-tab"
                                            data-bs-toggle="pill"
                                            data-bs-target="#v-pills-initial-check"
                                            type="button" role="tab"
                                            aria-controls="v-pills-initial-check"
                                            aria-selected="false">
                                        <span class="step-title me-2">
                                    ...
                                    <button class="nav-link"
                                            id="v-pills-payment-info-tab"
                                            data-bs-toggle="pill"
                                            data-bs-target="#v-pills-payment-info"
                                            type="button" role="tab"
                                            aria-controls="v-pills-payment-info"
                                            aria-selected="false">
                                        <span class="step-title me-2">
                                    ...
                                    <button class="nav-link"
                                            id="v-pills-other-info-tab"
                                            data-bs-toggle="pill"
                                            data-bs-target="#v-pills-other-info"
                                            type="button" role="tab"
                                            aria-controls="v-pills-other-info"
                                            aria-selected="false">
                                        <span class="step-title me-2">
