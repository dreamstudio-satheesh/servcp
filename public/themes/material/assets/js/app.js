!(function () {
                                ...
                                Array.from(e).forEach(function (e) {
                                    ...
                                    Array.from(e).forEach(function (e) {
                                        e.classList.remove("show"), 2 < e.childNodes.length &&
                                            ((e = e.querySelectorAll("ul li a")), Array.from(e).forEach(function (e) {
    ...
    function h() {
        ...
        !t || ("twocolumn" != e && "twocolumn" != t["data-layout"]) ||
            (document.querySelector(".navbar-menu") && (document.querySelector(".navbar-menu").innerHTML = u),
                ((o = document.createElement("ul")).innerHTML = '<a href="#" class="logo"><img src="assets/images/logo-sm.png" alt="" height="22"></a>'), Array.from(document.getElementById("navbar-nav").querySelectorAll(".menu-link")).forEach(function (e) {
                ...
                }), (e = (e = "/" == location.pathname ? "index.html" :
    ...
    function v(e) {
        if (e) {
            ...
            return t >= window.pageYOffset && a >= window.pageXOffset && t + n <= window.pageYOffset +
                window.innerHeight && a + o <= window.pageXOffset + window.innerWidth;
        }
    }
    ...
    function w(e) {
        ...
        if (e.target && e.target.matches("a.nav-link"))
            ...
            } else if (1 == v(e.target.nextElementSibling) && 1848 <=
                window.innerWidth)
            ...
            (e < 1025 && 767 < e ?
                (document.body.classList.remove("vertical-sidebar-enable"), "sm" == document.documentElement.getAttribute("data-sidebar-size") ?
                    ...
                    (document.body.classList.add("vertical-sidebar-enable"),
                        document.documentElement.setAttribute("data-sidebar-size", "lg"))), "twocolumn" == document.documentElement.getAttribute("data-layout") &&
    ...
    function O() {
        document.addEventListener("DOMContentLoaded", function () {
            ...
            window.addEventListener("resize", I), I(), Waves.init(), document.addEventListener("scroll", function () {
                var e;
                (e = document.getElementById("page-topbar")) && (50 <= document.body.scrollTop || 50 <=
            ...
            document.getElementById("topnav-hamburger-icon").addEventListener("click", M);
        var
            e = sessionStorage.getItem("defaultAttribute"),
            e = JSON.parse(e),
            t = document.documentElement.clientWidth;
        "twocolumn" == e["data-layout"] && t < 767 &&
    ...
    function A() {
        feather.replace();
        var e, t, a = "/" == location.pathname ? "index.html" :
    ...
    function L() {
        var e = "/" == location.pathname ?
            "index.html" : location.pathname.substring(1);
    ...
    function D() {
        var
            e = document.querySelectorAll(".counter-value");
    ...
    function B() {
        ...
        Array.from(o).forEach(function (e, t) {
            t + 1 === a && (s = e),
                ...
                s.insertAdjacentHTML("afterend", '<li class="nav-item">\t\t\t\t\t\t<a class="nav-link" href="#sidebarMore" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarMore">\t\t\t\t\t\t\t<i class="ri-briefcase-2-line"></i> More\t\t\t\t\t\t</a>\t\t\t\t\t\t<div class="collapse menu-dropdown" id="sidebarMore"><ul class="nav nav-sm flex-column">' +
                    n + "</ul></div>\t\t\t\t\t</li>");
        });
    }
        ...
        if (e == e) {
                    ...
                    "vertical" == sessionStorage.getItem("data-layout") && sessionStorage.getItem("data-layout") ?
                        ...
                        "horizontal" == sessionStorage.getItem("data-layout") ? (T("data-layout", "horizontal"),
                            ...
                            "twocolumn" == sessionStorage.getItem("data-layout") && (T("data-layout", "twocolumn"),
                                ...
                                document.documentElement.setAttribute("data-layout", "twocolumn"), k("twocolumn"));
            }
            switch (e["data-topbar"]) {
                ...
                case "dark":
                    ...
                    break;
                default:
                    "dark" == sessionStorage.getItem("data-topbar") ? (T("data-topbar", "dark"),
            ...
            switch (e["data-sidebar-size"]) {
                case "lg":
                    ...
                    break;
                case "sm":
                    T("data-sidebar-size", "sm"), document.documentElement.setAttribute("data-sidebar-size", "sm"),
                        sessionStorage.setItem("data-sidebar-size", "sm");
                    break;
                case "md":
                    T("data-sidebar-size", "md"), document.documentElement.setAttribute("data-sidebar-size", "md"),
                ...
                default:
                    "boxed" == sessionStorage.getItem("data-layout-width") ?
                        (sessionStorage.setItem("data-layout-width", "boxed"),
                            document.documentElement.setAttribute("data-layout-width", "boxed"), T("data-layout-width", "boxed")) : (sessionStorage.setItem("data-layout-width", "fluid"),
    ...
    function x() {
        setTimeout(function () {
            ...
            a &&
                ...
                (t = document.getElementsByClassName("app-menu") ? document.getElementsByClassName("app-menu")[0] : "") && t.querySelector(".simplebar-content-wrapper") && setTimeout(function () {
    ...
    function T(a, e) {
        Array.from(document.querySelectorAll("input[name=" + a + " ]")).forEach(function (t) {
            e == t.value ? (t.checked = !0) : (t.checked = !1), t.addEventListener("change", function () {
                var
                    e;
                document.documentElement.setAttribute(a, t.value), sessionStorage.setItem(a, t.value),
                    ...
                    ("vertical" == t.value ? (k("vertical"), f(), feather.replace()) : "horizontal" == t.value ?
                        ...
                        (document.documentElement.setAttribute("data-preloader", "enable"),
                            (e = document.getElementById("preloader")) && setTimeout(function () {
                                (e.style.opacity = "0"),
                                    (e.style.visibility = "hidden");
                            }, 1e3), document.getElementById("customizerclose-btn").click()) :
            ...
            Array.from(document.querySelectorAll("#collapseBgGradient .form-check input")).forEach(function (e) {
                ...
                1 == e.checked && new bootstrap.Collapse(t, {
                    toggle: !1
                }).show(), document.querySelector("[data-bs-target='#collapseBgGradient' ]") &&
    ...
    sessionStorage.getItem("defaultAttribute") ?
        ...
        ((i = document.documentElement.attributes), (a = {}), Array.from(i).forEach(function (e) {
            var t;
            e &&
        ...
        (d.addEventListener("focus", function () {
            0 < d.value.length ? (s.classList.add("show"),
            ...
            d.addEventListener("keyup", function (e) {
                ...
                0 < d.value.length ? (s.classList.add("show"),
                    ...
                    (t = document.getElementsByClassName("notify-item")), Array.from(t).forEach(function (e) {
                        var t, a,
                            o = "";
                        e.querySelector("h6") ? ((t = e.getElementsByTagName("span")[0].innerText.toLowerCase()),
                            ...
                            (e.style.display = o.includes(n) ? "block" : "none");
                ...
                function (e) {
                    "search-options" !== e.target.getAttribute("id") && (s.classList.remove("show"),
                        o.classList.add("d-none"));
        ...
        (i = document.querySelector('[data-toggle="fullscreen" ]')) && i.addEventListener("click", function (e) {
            e.preventDefault(), document.body.classList.toggle("fullscreen-enable"),
        ...
        (m = document.querySelectorAll(".light-dark-mode")) && m.length && m[0].addEventListener("click",
            function (e) {
                l.hasAttribute("data-layout-mode") && "dark" == l.getAttribute("data-layout-mode") ?
                    C("data-layout-mode", "light", "layout-mode-light", l) : C("data-layout-mode", "dark", "layout-mode-dark", l);
            }), O(), D(), S(), document.getElementsByClassName("dropdown-item-cart") &&
        ...
        Array.from(m).forEach(function (a) {
            a.addEventListener("click", function () {
                ...
                t["data-toast-text"] && (e.text = t["data-toast-text"].value.toString()),
                    ...
                    (e.offset = t["data-toast-offset"]), Toastify({
                        newWindow: !0,
                        text: e.text,
                        gravity: e.gravity,
                        position: e.position,
        ...
        (m = document.querySelectorAll("[data-choices]")), Array.from(m).forEach(function (e) {
            ...
            a["data-choices-groups"] &&
                ...
                a["data-choices-text-disabled-true"] && (t.addItems = !1), a["data-choices-text-disabled-true"] ? new
                    Choices(e, t).disable() : new Choices(e, t);
            ...
            "flatpickr" == e.getAttribute("data-provider") ?
                ((o = e.attributes), ((t = {}).disableMobile = "true"), o["data-date-format"] &&
                    ...
                    flatpickr(e, t)) : "timepickr" == e.getAttribute("data-provider") && ((a = {}),
                        (o = e.attributes)["data-time-basic"] && ((a.enableTime = !0), (a.noCalendar = !0), (a.dateFormat = "H:i")), o["data-time-hrs"] && ((a.enableTime = !0), (a.noCalendar = !0), (a.dateFormat = "H:i"),
                            (a.time_24hr = !0)), o["data-min-time"] && ((a.enableTime = !0), (a.noCalendar = !0), (a.dateFormat = "H:i"), (a.minTime = o["data-min-time"].value.toString())), o["data-max-time"] && ((a.enableTime = !0),
